...
export default function InvitePage() {
  ...
  return (
    <main id="main-content" className="flex min-h-screen flex-col items-center justify-center p-8">
      ...
      <p className="text-gray-600 mb-8">Genereer een code om iemand uit te nodigen</p>
      ...
      {!code ? (
        ...
        <div className="w-full max-w-sm space-y-4">
          <div className="rounded-lg bg-gray-50 p-4 text-center">
            <p className="text-sm text-gray-600 mb-1">Uitnodigingscode</p>
            <p className="text-2xl font-mono font-bold text-emerald-600 tracking-wider">{code}</p>
          </div>

          {inviteUrl && (
            <div className="rounded-lg bg-gray-50 p-4">
              <p className="text-sm text-gray-600 mb-1">Of deel deze link</p>
