...
export function KlusjesForm({ onAdd }: KlusjesFormProps) {
  ...
  return (
    <div>
      ...
      {expanded && (
        <div id="klusje-options" className="mt-2 space-y-2 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600">
          <div>
            <label htmlFor="klusje-date" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
              Datum
            </label>
            <input
              id="klusje-date"
              ...
              className="mt-1 w-full rounded-lg border border-gray-300 dark:border-gray-600 px-3 py-2 text-gray-900 dark:text-gray-100 dark:bg-gray-700 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500 focus:outline-none"
            />
          </div>
          <div>
            <label htmlFor="klusje-recurrence" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
              Herhaling
            </label>
            <select
          ...
          {recurrence !== "none" && (
            <div className="space-y-2">
              <div>
                <label htmlFor="klusje-interval" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                  Elke
                </label>
                <div className="flex items-center gap-2 mt-1">
                  <input
                    ...
                    className="w-20 rounded-lg border border-gray-300 dark:border-gray-600 px-3 py-2 text-gray-900 dark:text-gray-100 dark:bg-gray-700 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500 focus:outline-none"
                  />
              ...
              <div>
                <label htmlFor="klusje-enddate" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                  Loopt tot
                </label>
                <input
                  id="klusje-enddate"
              ...
              <div>
                <label htmlFor="klusje-weeks" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                  Aantal weken
                </label>
                <input
                  id="klusje-weeks"
          ...
          <div>
            <span className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Prioriteit</span>
                  ...
                  <button
                    ...
                    className={`px-3 py-1 rounded-lg text-sm font-medium border ${
                      priority === p
                        ...
                        : "bg-white text-gray-500 border-gray-300 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600"
                    }`}
                  >
                    {config.label}
                  </button>
