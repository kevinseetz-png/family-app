  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-3">
        <h3 className="text-sm font-semibold text-gray-700">Eigen categorieën</h3>
        <button
      ...
      {showForm && (
        <div className="mb-4 space-y-3 p-3 bg-gray-50 rounded-xl border border-gray-200">
          <div>
            <label htmlFor="cat-label" className="block text-xs text-gray-500 mb-1">Naam</label>
            <input
              id="cat-label"
              type="text"
              value={label}
          ...
          <div>
            <label htmlFor="cat-emoji" className="block text-xs text-gray-500 mb-1">Emoji</label>
            <input
              id="cat-emoji"
              type="text"
              value={emoji}
      ...
      {categories.length === 0 && !showForm && (
        <p className="text-sm text-gray-400">Geen eigen categorieën</p>
      )}
